...
I made this little script to turn any eased animation into stop motion style holds, and keep your easing.

## What it does

Cavalry doesn't have a Posterize Time effect, so Stepper does it with keyframes. Select some keys, pick a frame rate, and Stepper samples the curve between them and writes Step (hold) keyframes at that rate.
